...
#ifdef WIN32
string  GLTexture::_glsl_names[3] = { "tex", "texture_blend"};

string  GLMultiTexture::_glsl_names[4] = { "texture_background", "texture_foreground", "texture_gradient", "texture_blend"};
#endif
...
/*!
 ...
 @return int - the texture id when the texture was sucessfully loaded.
 */
int GLMultiTexture::loadAndCreateTextures(	string path_and_file_texture_1,
...
bool GLMultiTexture::addVariablesToProgram(GLuint program, int variable_index)
{
	...
	bool b = checkUniform(_textureIdx3, _glsl_names[2]);
